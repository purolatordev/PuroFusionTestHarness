...
/****** Object:  StoredProcedure [dbo].[sp_OnboardingTimePerITBAOnlyEDI]    Script Date: 2022/01/24 11:39:38 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE  PROCEDURE [dbo].[sp_OnboardingTimePerITBAOnlyEDI]
(
@fromdate DateTime,
@todate DateTime,
@idITBA int
...
BEGIN
	...
	left join purolatorReporting..tblEmployee e on e.ActiveDirectoryName = n.CreatedBy
	left join tblITBA itba on e.ActiveDirectoryName = itba.login
