...
/****** Object:  Trigger [dbo].[Trigger_tblDiscoveryRequest_Archive_Update]    Script Date: 8/2/2021 3:39:19 PM ******/
SET ANSI_NULLS ON
GO
...
create TRIGGER [dbo].[Trigger_tblDiscoveryRequest_Archive_Update]
...
ALTER TABLE [dbo].[tblDiscoveryRequest] ENABLE TRIGGER [Trigger_tblDiscoveryRequest_Archive_Update]
GO
