CREATE TABLE [dbo].[tblEDIRecipReqs] (
    ...
    [idStatusCodesNonCourierEDI] INT            NOT NULL,
    [idStatusCodesCourierEDI]    INT            NOT NULL,
    ...
    CONSTRAINT [FK_idStatCodeCourierEDI_StatusCode] FOREIGN KEY ([idStatusCodesCourierEDI]) REFERENCES [dbo].[tblStatusCodesCourierEDI] ([idStatusCodesCourierEDI]),
    CONSTRAINT [FK_idStatCodeNonCourierEDI_StatusCode] FOREIGN KEY ([idStatusCodesNonCourierEDI]) REFERENCES [dbo].[tblStatusCodesNonCourierEDI] ([idStatusCodesNonCourierEDI]),
